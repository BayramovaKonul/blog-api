...
from .views import (UpdateUserProfile, UpdateUserProfilePicture, RegisterUserView, 
                    UserFollowerView, MyFollowersView, ConfirmPasswordResetView, RequestPasswordResetView)
...
urlpatterns = [
    ...
    path('confirm-reset-password/', ConfirmPasswordResetView.as_view(), name='confirm-reset-password'),
]
